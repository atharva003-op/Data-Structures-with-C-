//Linked list program for student information and a multiplication table!
#include <iostream>
#include <string>
#include <limits>
...
int main () {
    ...
    do {
        ...
        std::cout <<"7.Search detail\n";
        std::cout <<"8.Display details\n";
        std::cout <<"9.Multiplication table\n";
        std::cout <<"10.Exit\n";
        ...
        if (choice == 1) {
            ...
            std::cout <<"Enter Roll No to get details : ";
            std::cin >>key;
            ...
            if (head == nullptr) {
                ...
                while (temp != nullptr) {
                    if (temp->rollno == key) {
                        std::cout <<"\nDetails Found : \n";
                        std::cout <<"Name : "<<temp->name<<" | Roll No : "<<temp->rollno<<" | Age : "<<temp->age<<" | Total Marks : "<<temp->m1+temp->m2+temp->m3<<"\n";
                        temp = temp ->next;
                        found = true;
                        break;
                    }
